...
LRESULT CALLBACK SaltedExplorer::BookmarksToolbarSubclass(HWND hwnd,UINT uMsg,WPARAM wParam,LPARAM lParam)
{
	switch(uMsg)
	{
	case WM_MBUTTONUP:
...
void SaltedExplorer::InsertBookmarksIntoMenu(void)
{
...
void SaltedExplorer::InsertBookmarksIntoMenuInternal(HMENU hMenu,
...
void SaltedExplorer::InsertBookmarkToolbarButtons(void)
{
	Bookmark_t		RootBookmark;
	HIMAGELIST		himl;
	HBITMAP			hb;
...
void SaltedExplorer::InsertToolbarButtonsInternal(Bookmark_t *pBookmark)
{
...
void SaltedExplorer::InsertBookmarkIntoToolbar(Bookmark_t *pBookmark,int id)
{
	TBBUTTON	tbButton;
	int			iImage;
...
void SaltedExplorer::UpdateToolbarButton(Bookmark_t *pBookmark)
{
	TBBUTTONINFO tbbi;
	TBBUTTON tbButton;
	int iImage;
...
void SaltedExplorer::InsertBookmarksIntoTreeView(HWND hTreeView,
...
void SaltedExplorer::InsertBookmarksIntoTreeViewInternal(HWND hTreeView,
HTREEITEM hParent,Bookmark_t *pBookmark)
{
	TVINSERTSTRUCT	tvis;
	TVITEMEX		tvItemEx;
...
void SaltedExplorer::InsertBookmarkFolderItemsIntoTreeView(HWND hFolders,
HTREEITEM hParent,Bookmark_t *pBookmark)
{
	TVINSERTSTRUCT	tvis;
	TVITEMEX		tvItemEx;
...
void SaltedExplorer::InsertBookmarksIntoListView(HWND hBookmarks,Bookmark_t *pBookmark)
{
	LVITEM			lvItem;
...
void SaltedExplorer::InsertFolderItemsIntoComboBox(HWND hCreateIn,Bookmark_t *pBookmark)
{
	InsertFolderItemsIntoComboBoxInternal(hCreateIn,pBookmark,0,0);
}

void SaltedExplorer::InsertFolderItemsIntoComboBoxInternal(HWND hCreateIn,Bookmark_t *pBookmark,
...
int SaltedExplorer::LocateBookmarkInComboBox(HWND hComboBox,void *pBookmarkHandle)
{
	LONG_PTR	lResult;
	int			nItems;
	int			i = 0;
...
void SaltedExplorer::InitializeBookmarkToolbarMap(void)
{
	int i = 0;
...
int SaltedExplorer::GenerateUniqueBookmarkToolbarId(void)
{
	BOOL	bFound = FALSE;
	int		i = 0;
...
void SaltedExplorer::GetBookmarkMenuItemDirectory(HMENU hMenu,
...
void SaltedExplorer::BookmarkToolbarOpenItem(int iItem,BOOL bOpenInNewTab)
{
	Bookmark_t	Bookmark;
	TBBUTTON	tbButton;
...
void SaltedExplorer::BookmarkToolbarDeleteItem(int iItem)
{
	TBBUTTON	tbButton;
	BOOL		bDeleted;
...
void SaltedExplorer::BookmarkToolbarShowItemProperties(int iItem)
{
	Bookmark_t					Bookmark;
...
void SaltedExplorer::BookmarkToolbarNewBookmark(int iItem)
{
...
void SaltedExplorer::BookmarkToolbarNewFolder(int iItem)
{
	g_iFolderSelected = 0;
...
void SaltedExplorer::RemoveItemFromBookmarksToolbar(void *pBookmarkHandle)
{
	TBBUTTON	tbButton;
	LRESULT		lResult;
	int			nButtons;
...
BOOL SaltedExplorer::DeleteBookmarkSafe(HWND hwnd,void *pBookmarkHandle)
{
	TCHAR szInfoMsg[128];
