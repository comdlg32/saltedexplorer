...
void SaltedExplorer::UpdateDisplayWindow(void)
{
	int nSelected;
...
void SaltedExplorer::UpdateDisplayWindowForZeroFiles(void)
{
...
void SaltedExplorer::UpdateDisplayWindowForOneFile(void)
{
...
void SaltedExplorer::UpdateDisplayWindowForMultipleFiles(void)
{
