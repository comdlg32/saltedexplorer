...
#define REG_APPLICATIONS_KEY		_T("Software\\SaltedExplorer\\ApplicationToolbar")
#define REG_DIALOGS_KEY				_T("Software\\SaltedExplorer\\Dialogs")
#define REG_COLORS_KEY				_T("Software\\SaltedExplorer\\ColorRules")
